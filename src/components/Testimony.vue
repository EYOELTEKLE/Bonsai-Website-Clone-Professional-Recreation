...
<template>
    <div class=" mt-2 -mb-5 mobile-version_features_wrapper_parent  md:hidden mx-auto">
      <h1 class="ml-2 mr-2 font-extrabold text-xl text-center text-headfuse ">Cut costs, not features.</h1>
      <div class="w-full px-4 mx-auto pt-7">
        <div class="mx-auto w-full max-w-md rounded-2xl bg-white p-2">
          <Disclosure v-slot="{ open }">
            <DisclosureButton class="flex w-full justify-between  rounded-lg px-4 py-2 text-left text-sm font-medium">
                <div class="statements_1_wrapper flex flex-col border-b-2 border-gray-200 pb-2 border-6 w-[292.24px]">
                    <p class="font-bold text-sm iphone:text-lg">Manage your finances</p>
                    <p class="text-xs my-1 font-base text-greenfuse">Get paid, handle bookkeeping & Manage your Money</p>
                </div>
               
              <ChevronUpIcon :class="open ? 'rotate-180 transform' : ''" class="h-5 w-5 text-green-600" />
            </DisclosureButton>
          ...
          <Disclosure v-slot="{ open }">
            <DisclosureButton class="flex w-full justify-between rounded-lg px-4 py-2 text-left text-sm font-medium">
                <div class="statements_1_wrapper flex flex-col border-b-2 border-gray-200 pb-2 border-6 w-[292.24px]">
                    <p class="font-bold text-sm iphone:text-lg">Manage Clients</p>
                    <p class="text-xs my-1 font-base text-greenfuse">Turn leads into Clients seamlessly & win more work</p>
                </div>
          ...
          <Disclosure v-slot="{ open }">
            <DisclosureButton class="flex w-full justify-between rounded-lg px-4 py-2 text-left text-sm font-medium">
                <div class="statements_1_wrapper flex flex-col border-b-2 border-gray-200 pb-2 border-6 w-[292.24px]">
                    <p class="font-bold text-sm iphone:text-lg">Projects</p>
                    <p class="text-xs my-1 font-base text-greenfuse">Track your projects from opportunity to delivery</p>
                </div>
    ...
    <div class="testimony_parent_wrapper_element mt-24 relative bg-testimony-bg Nesthub:overflow-hidden mid-laptop:overflow-visible bg-headfuse rounded-3xl gap-4 md:gap-48 Nesthub:ml-10 mid-laptop:mx-auto max-w-fit flex flex-col justify-center items-center mx-auto iphone:grid iphone:grid-cols-2 iphone:grid-rows-3 w-[280px] h-[329px] iphone:w-[573px] iphone:h-[655px] md:w-[1280px]  md:h-[584px]">
      <div class="grid-1 flex items-center -mt-20 iphone:mt-20 h-full row-start-1 row-end-3">
        <h1 class="text-white text-xs  iphone:text-base md:text-xl lg:text-3xl  max-w-32 ml-8 font-semibold"> “Bonsai is a great hub for my business. It’s super simple to use. I would really recommend it for anyone who is after an easy-to-use CRM system without the hassle of complicated setups.” </h1>
      </div>
      ...
      <div class="grid-4 row-start-3 ml-8 flex flex-col justify-start items-start ">
        <div class="features flex gap-4 Galaxy-Fold:-mt-30 md:-mt-14 iphone:gap-10 md:grap-12">
          <p class="text-white   pr-3 py-3 font-semibold border-t-2">01</p>
          <p class="text-white   pr-12 iphone:pr-40 py-3 font-semibold border-t-2 border-green-500">02</p>
          <p class="text-white   pr-3 py-3 font-semibold border-t-2">03</p>
        </div>
        <p class="mt-2 mb-4 iphone:-mb-4 iphone:mt-7 text-white font-bold text-xs iphone:text-sm">Laura, <span class="font-extrabold">Coach at Ebb, Flow & Grow</span>
        </p>
      </div>
    </div>
  </template>
